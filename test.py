...
class PanZoomCanvas(tk.Frame):
    ...
    def create_widget(self, width, height):
        ...
        self.canvas = tk.Canvas(
            self.master, background="black", width=width, height=height)
        self.canvas.pack()
    ...
    def draw_image(self, pil_image):
        ...
        dst = self.pil_image.transform(
            ...
            # Affine transformation matrix (conversion matrix from output to input)
            affine_inv,
...
if __name__ == "__main__":
    ...
    app.set_image('C:/Users/Philipp/Downloads/cover.jpg')
    app.mainloop()
